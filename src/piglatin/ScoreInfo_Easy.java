...
public class ScoreInfo_Easy extends javax.swing.JFrame {
    ...
    public ScoreInfo_Easy() {
        ...
        String scr = Integer.toString(QA_Easy.score);
        totalScore.setText(scr);
        String c = Integer.toString(QA_Easy.correct);
        correctNo.setText(c);
    ...
    private void initComponents() {
        ...
        ezBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projectSource/scte.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScoreInfo_Easy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
